...
class WitchTest < ActiveSupport::TestCase
  test "generate name" do
    character = Witch.new(1)
    assert_equal "Witch 1", character.name
    character = Witch.new(2)
    assert_equal "Witch 2", character.name
  end

  test "take damage" do
    character = Witch.new(1, 100)
